            ...
            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 relative px-4">
                ...
                <div className="flex flex-col space-y-3 w-full shadow-red-600 p-4 rounded-lg bg-black text-white backdrop-blur-sm border border-red-950">
                    <ul className="space-y-3">
                        ...
                        <li className="flex items-baseline">
                            <span className="text-neutral-600 font-bold ">Priority:</span> 
                            <span className="text-[15px] ml-2">
                                {data.isPriority ? "Yes" : "No"}
                            </span>
                        </li>
                        <li className="flex items-baseline">
                        ...
                        <li className="flex items-baseline">
                            <span className="text-neutral-600 font-bold">Phy Ticket Type:</span> 
                            <span className="text-[15px] ml-2">{data.TicketType}</span>
                        </li>
                        <li className="flex items-baseline">
                ...
                <div className="flex flex-col space-y-3 w-full shadow-red-950 p-4 rounded-lg bg-black text-white backdrop-blur-sm border border-red-500/20">
                    <ul className="space-y-3">
                        ...
                        <li className="flex items-baseline">
                            ...
                            <span className="text-[15px] ml-2">{data.status}</span>
                        </li>
                        <li className="flex items-baseline">
                        ...
                        <li className="flex items-baseline">
                            <span className="text-neutral-600 font-bold ">Remaining slot:</span> 
                            <span className="text-[15px] ml-2">{data.remainingSlots}</span>
                        </li>
                        <li className="flex items-baseline">
