...
const DashBoardVideoCard = ({ isLive, img, video }: ThumbnailCardProps) => {
  ...
  return (
    <div
      className='h-[200px] lg:h-[700px] md:h-[500px] w-full border-[#b28228] border-b-2 overflow-hidden cursor-pointer relative'
      style={{
        backgroundImage: `url(${img})`, // Set the background image dynamically
        backgroundSize: 'cover',
        backgroundPosition: 'center',
    ...
    >
      ...
      <div className='absolute inset-0 flex items-center justify-center z-10 w-full'>
        {isYouTubeVideo ? (
          ...
          <iframe
            className='w-[300px] md:w-[600px] md:h-[400px] lg:w-[900px] lg:h-[500px] h-auto'
