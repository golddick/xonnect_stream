...
const SponsorCard = () => {
  return (
    <div className="bg-gradient-to-r from-red-600/20 via-black-500/20 to-red-500/20 p-6 rounded-xl mb-8 relative overflow-hidden group cursor-pointer border-none">
                        ...
                        <div className="relative z-10 flex items-center gap-6">
                            <div className=" w-40 md:w-72 h-40 overflow-hidden rounded-lg border border-white/20 relative">
                                <Image
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                    <span className="bg-gradient-to-r from-red-600 to-gold text-white px-3 py-1 rounded-full text-xs font-semibold">
                                        PREMIUM
                                    </span>
                                    <span className="bg-black/50 text-white px-3 py-1 rounded-full text-xs font-semibold backdrop-blur-sm  text-nowrap">
                                        TONIGHT 8PM
                                    </span>
                                </div>
                                <h2 className="text-white text-xl md:text-2xl font-bold mb-2">Global Music Awards Live Stream</h2>
