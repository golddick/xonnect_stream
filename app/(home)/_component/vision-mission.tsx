    ...
    <section className="py-16 px-4 sm:px-8 bg-white overflow-hidden">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16 animate-fadeIn">
                            <h2 className="text-3xl sm:text-4xl font-bold mb-3">Our Vision & Mission</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div className="bg-gradient-to-br from-red-600/90 to-red-800 text-white p-8 rounded-xl shadow-lg transform hover:-translate-y-3 transition-all duration-500 animate-fadeInLeft hover:shadow-red-500/30 hover:shadow-xl">
                                <div className="border-2 border-white/20 rounded-xl p-6 h-full flex flex-col relative overflow-hidden group">
                                    ...
                                    <p className="text-white/90 text-lg leading-relaxed mb-6 relative">
                                        To create a world where distance is no longer a barrier to experiencing life&apos;s
                                        most memorable moments. We envision a future where anyone, anywhere can access
                                        extraordinary events and connect with global communities through seamless,
                                        high-quality streaming.
                                    </p>
                                    <p className="text-white/90 text-lg leading-relaxed mt-auto relative">
                                        By 2025, we aim to be the premier destination for exclusive content across
                                        entertainment, education, sports, and cultural experiences, serving over 50
